...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="bg-card dark:bg-surface-dark p-8 rounded-2xl shadow-lg w-full relative">
       <Link to="/" className="absolute top-4 left-4 text-text-secondary dark:text-text-secondary-dark hover:text-navy dark:hover:text-text-primary-dark transition-colors" aria-label="Back to selection">
        <FaArrowLeft size={20} />
      </Link>
