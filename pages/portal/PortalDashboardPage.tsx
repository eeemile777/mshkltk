...
const PortalDashboardPage: React.FC = () => {
    ...
    const statusCardsData = [
        { title: t.newReports, value: stats.new, icon: <FaTriangleExclamation size={24} className="text-white"/>, color: "bg-coral dark:bg-coral-dark", reportsList: topNewReports, status: ReportStatus.New },
        { title: t.receivedReports, value: stats.received, icon: <FaList size={24} className="text-white"/>, color: "bg-sky dark:bg-cyan-dark", reportsList: topReceivedReports, status: ReportStatus.Received },
        { title: t.inProgressReports, value: stats.inProgress, icon: <FaHourglassHalf size={24} className="text-white"/>, color: "bg-teal dark:bg-teal-dark", reportsList: topInProgressReports, status: ReportStatus.InProgress },
        { title: t.resolvedReports, value: stats.resolved, icon: <FaCheck size={24} className="text-white"/>, color: "bg-mango dark:bg-mango-dark", reportsList: topResolvedReports, status: ReportStatus.Resolved },
    ];
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <StatCard title={t.totalReports} value={stats.total} icon={<FaFolder size={28} className="text-white"/>} color="bg-sky dark:bg-cyan-dark" />
                <StatCard title={t.avgAgeOpenReports} value={`${stats.avgAge} ${t.days}`} icon={<FaRegClock size={28} className="text-white"/>} color="bg-navy dark:bg-sand text-sand dark:text-navy" />
            </div>
