...
const getActionIcon = (message: string) => {
    ...
    if (lowerMessage.includes('delete')) return <FaTrash className="text-coral" />;
    if (lowerMessage.includes('create') || lowerMessage.includes('submitted')) return <FaPlus className="text-teal" />;
    if (lowerMessage.includes('update') || lowerMessage.includes('change')) return <FaPen className="text-sky" />;
