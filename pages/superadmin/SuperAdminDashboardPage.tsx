    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <StatCard title={t.totalUsers} value={stats.totalUsers} icon={<FaUsers size={28} className="text-white"/>} color="bg-teal dark:bg-teal-dark" />
                <StatCard title={t.totalReportsSA} value={stats.totalReports} icon={<FaListCheck size={28} className="text-white"/>} color="bg-sky dark:bg-cyan-dark" />
                <StatCard title={t.totalMunicipalities} value={stats.totalMunicipalities} icon={<FaBuilding size={28} className="text-white"/>} color="bg-mango dark:bg-mango-dark" />
                <StatCard title={t.avgAgeOpenReports} value={`${stats.avgResolutionDays} ${t.days}`} icon={<FaRegClock size={28} className="text-white"/>} color="bg-navy dark:bg-sand text-sand dark:text-navy" />
            </div>
