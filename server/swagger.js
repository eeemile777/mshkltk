    ...
    components: {
      ...
      schemas: {
        ...
        DynamicCategory: {
          type: 'object',
          properties: {
            id: { type: 'string', example: 'lighting' },
            label_en: { type: 'string', example: 'Lighting' },
            label_ar: { type: 'string', example: 'إضاءة' },
            name_en: { type: 'string', example: 'Lighting' },
            name_ar: { type: 'string', example: 'إضاءة' },
            icon: { type: 'string', example: '💡' },
            color: { type: 'string', description: 'Light theme color', example: '#FFC107' },
            color_dark: { type: 'string', description: 'Dark theme color', example: '#FF9800' },
            sub_categories: { 
              type: 'array', 
              description: 'Array of sub-category names',
              items: { type: 'string' }, 
              example: ['Street Lights', 'Public Buildings', 'Parks'] 
            },
            is_active: { type: 'boolean', example: true },
            created_at: { type: 'string', format: 'date-time', example: '2025-01-01T00:00:00Z' },
            updated_at: { type: 'string', format: 'date-time', example: '2025-11-19T10:30:00Z' },
          },
          example: {
            id: 'lighting',
            label_en: 'Lighting',
            ...
            color: '#FFC107',
            color_dark: '#FF9800',
            sub_categories: ['Street Lights', 'Public Buildings', 'Parks'],
            is_active: true,
          },
        },
        DynamicBadge: {
        ...
        AuditLog: {
          type: 'object',
          properties: {
            id: { type: 'string', example: 'audit-123' },
            actorId: { type: 'string', description: 'ID of the user who performed the action', example: 'user-456' },
            actorName: { type: 'string', description: 'Display name of the actor', example: 'John Admin' },
            actorRole: { 
              type: 'string', 
              enum: ['citizen', 'municipality', 'utility', 'union_of_municipalities', 'super_admin'],
              example: 'super_admin' 
            },
            message: { type: 'string', description: 'Human-readable action description', example: 'create_category' },
            timestamp: { type: 'string', format: 'date-time', example: '2025-11-19T12:00:00Z' },
            actionType: { type: 'string', description: 'Action type identifier', example: 'create_category' },
            entityType: { type: 'string', description: 'Type of entity affected', example: 'category' },
            entityId: { type: 'string', description: 'ID of the affected entity', example: 'lighting' },
            details: { type: 'object', description: 'Additional action details', example: { category: { id: 'lighting', name_en: 'Lighting' } } },
          },
          example: {
            id: 'audit-123',
            actorId: 'user-456',
            ...
            entityType: 'category',
            entityId: 'lighting',
            details: { category: { id: 'lighting', name_en: 'Lighting' } },
          },
        },
        Municipality: {
          type: 'object',
