...
const DB_NAME = 'mshkltk-app-db';
const DB_VERSION = 4; // Incremented version to force a full DB rebuild.
const STORES = ['users', 'reports', 'notifications', 'comments', 'reportHistory', 'sessions'];
...
export const dbService = {
  ...
  // FIX: Added `superAdmin` parameter to match the call signature and properly seed the super admin user. The error was reported for a different file but originated from this mismatch.
