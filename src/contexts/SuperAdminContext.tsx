    ...
    if (currentUser) {
      const fetchData = async () => {
        ...
        try {
          ...
          // Normalize gamification settings - convert 'rules' from API to 'pointsRules' for frontend
          const normalizedGamification = gamificationData ? {
            id: 'default' as const,
            pointsRules: gamificationData.rules || gamificationData.pointsRules || []
          } : null;
          setGamificationSettings(normalizedGamification);
