...
import { FaMoon, FaSun, FaGlobe, FaTrophy, FaArrowRightFromBracket, FaCircleExclamation, FaClockRotateLeft, FaRankingStar, FaCamera, FaCirclePlay, FaCircleInfo } from 'react-icons/fa6';
...
const ProfilePage: React.FC = () => {
  ...
  const TabButton: React.FC<{ tabId: ActiveTab; label: string }> = ({ tabId, label }) => (
    <button
      ...
      className={`px-4 py-2 text-sm sm:text-base font-bold transition-colors ${activeTab === tabId
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card dark:bg-surface-dark p-6 rounded-2xl shadow-md mb-8 flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-start flex-1 w-full">
              ...
              <div className="flex flex-wrap justify-center sm:justify-start gap-2 mt-4">
                {currentUser.achievements && currentUser.achievements.length > 0 && currentUser.achievements.map((badgeId) => (
                  BADGES[badgeId] ? (
          ...
          <div className="bg-card dark:bg-surface-dark p-6 rounded-2xl shadow-md">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <label className="font-medium text-text-secondary dark:text-text-secondary-dark">{t.aboutPage}</label>
                <Link to={PATHS.ABOUT} className="p-2 rounded-full bg-muted dark:bg-bg-dark text-navy dark:text-text-primary-dark hover:bg-teal/20 dark:hover:bg-teal-dark/20 transition-colors">
                  <FaCircleInfo {...({} as any)} />
                </Link>
              </div>
              <div className="flex items-center justify-between">
